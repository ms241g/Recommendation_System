...
def predict():
    if (request.method == 'POST'):
        ...
        # print(user_input)
        pickled_tfidf_vectorizer = pickle.load(open('model/Tfidf_vectorizer.pkl', 'rb'))
        pickled_model = pickle.load(open('model/Logistic_Reg_final_model.pkl', 'rb'))
        pickled_user_final_rating = pickle.load(open('model/user_final_rating.pkl', 'rb'))
        pickled_mapping = pickle.load(open('model/prod_id_name_mapping.pkl', 'rb'))
        pickled_reviews_data = pickle.load(open('model/reviews_data_all_cols.pkl', 'rb'))
